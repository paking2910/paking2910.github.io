...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        <img src="https://media1.tenor.com/m/AzDQuOWC7R0AAAAC/i-swear-to-god-i-will-find-you-and-i-will-burn-your-house-down-dog.gif" class="gif">
        <div class="question">YAYAYYAYAYAYAY Happy Valentine's Day❤️🌻</div>
    `;
    launchConfetti();
    startHeartRain();
}
